...
const PaymentCallbackImePay = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        const { data } = await paymentService.verifyImePay(raw);
        if (data?.success) {
          setStatus("success");
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-lg px-4 py-12 text-center">
          <h1 className="text-2xl font-bold">IME Pay Payment</h1>
...
export default PaymentCallbackImePay;
